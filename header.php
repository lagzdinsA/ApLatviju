...
<body class="d-flex flex-column min-vh-100" style="background-color: #FFFBEE;">
    <header class="pt-3 mb-5 sticky-top" style="background-color: #FFFBEE">
        <div class="d-flex justify-content-around">
            ...
            <h1 class="display-7">
                <a class="fw-bold link-underline link-underline-opacity-0 link-underline-opacity-0-hover"
                    style="color: #F96C03;" href="index.php">Apskatīt Latviju
    ...
    <div class="container">
        ...
        <!--Makes it so a popup doesn't show everytime you refresh or close page with inputs-->
        <script>
